...
| 金属名称 | 作用情况                                                                                             | 作用条件                                | 作用速度 |
| :------: | :------------------------------------------------------------------------------------------------- | :-------------------------------------- | :------: |
|    铜    | (1)$Hg(ONC)_2 + Cu \rightarrow Cu(ONC)_2 + Hg$ <br> (2) 生成 $Cu(ONC)_2 \cdot Cu(OH)_2$ (摩擦感度高) | (1) 有水存在时并加热<br> (2) 有水存在时 |          |
...
<div style="text-align: center;">表 8 &nbsp;&nbsp; 15℃ 时盐酸比重</div>
...
<div style="text-align: center;">表 9 雷汞制造所用的设备、工具和仪器</div>
...
<div style="text-align: center;">表10 雷银制造所用的设备、工具和仪器</div>
